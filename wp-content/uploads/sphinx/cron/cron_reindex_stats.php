 ...
 */
// 5 0 * * * /usr/bin/php /var/www/html/wordpress/wp-content/uploads/sphinx/cron/cron_reindex_main.php

define('PATH_TO_SPHINX_INDEXER', '/usr/bin/indexer');
define('PATH_TO_SPHINX_CONFIG', '/var/www/html/wordpress/wp-content/uploads/sphinx/sphinx.conf');
